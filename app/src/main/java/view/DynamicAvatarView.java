...
public class DynamicAvatarView extends ImageView {
    ...
    private static final String TAG = "DynamicAvatarView";
    ...
    private float mChangeRateBorder;//记录图片边框执行动画时半径变化率
    private float mChangeRateOuter;//记录外圆执行动画时半径变化率
    private float mChangeRateInner;//记录内圆执行动画时半径变化率
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e(TAG, "width: "+widthSize+"  height："+heightSize );
