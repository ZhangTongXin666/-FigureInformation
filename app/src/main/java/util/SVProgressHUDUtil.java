...
public class SVProgressHUDUtil {
    ...
    private static SVProgressHUDUtil mSVProgressHUDUtil;
    ...
    private static final SVProgressHUDUtil getInstance(Context context) {
        if (mSVProgressHUDUtil == null) {
            mSVProgressHUDUtil = new SVProgressHUDUtil();
            mSVProgressHUDUtil.context = context;
            mSVProgressHUDUtil.gravity = Gravity.CENTER;
            mSVProgressHUDUtil.initViews();
            mSVProgressHUDUtil.initDefaultView();
            mSVProgressHUDUtil.initAnimation();
        }
        if (context != null && context != mSVProgressHUDUtil.context ){
            mSVProgressHUDUtil.context = context;
            mSVProgressHUDUtil.initViews();
        }

        return mSVProgressHUDUtil;
    }
